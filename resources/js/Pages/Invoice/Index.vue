        ...
        <BodyLayoutVue>
            <div class="w-full mb-4">
                <label class="input">
                    ...
                    <input type="search"
                        class="text-lg p-4 w-full border border-gray-300 rounded-lg focus:outline-none focus:ring-0"
                        placeholder="Search" v-model="filterForm.name"
                        @input="filterForm.name.length >= 1 ? autoFilter('invoice.index') : null" />
                </label>
            </div>
            <div class="overflow-x-auto">
                <table class="table table-xs">
                    ...
                    <tbody>
                        <tr v-for="invoice in invoices.data" :key="invoice.id" :value="invoice.id">
                            <td>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    height="800px" width="800px" version="1.1" id="Layer_1"
                                    viewBox="0 0 303.188 303.188" xml:space="preserve" class="w-6 h-6">
                                    <g>
